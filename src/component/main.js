  ...
  <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div class="p-2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span class="title-font font-bold text-2xl">DAILY LIVE ZOOM SESSIONS</span>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span class="title-font font-bold text-2xl">1 DEC TO 31 DEC</span>
      ...
      <div class="p-2 sm:w-1/ w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span class="title-font font-bold text-2xl">9:15 PM TO 10:30 PM</span>
        </div>
      </div>
    </div>
    <div className="flex justify-center mt-4">
          ...
          <button className="ml-4 inline-flex  text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg"><a href="https://chat.whatsapp.com/KwzLe4ihYAfCOuYNVqiPud" > Join WhatsApp Group</a></button>
        </div>
  </div>
