  ...
  let videoContainerStyle = {
    ...
    let  iframeStyle = {
        ...
        return (
            ...
            <div class="flex flex-col text-center w-full sm:-mb-14" id="video">
            <h1 class="sm:text-5xl text-2xl font-bold title-font " style={{"color":"rgba(91,29,236,255)"}}>Why You Should Join!</h1>
           </div>
            ...
            <div className="flex flex-wrap -m-4">
              <div className="p-4 sm:w-1 md:w-1/2 md:ml-auto md:mr-auto ">
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div className="p-6">
                   <h1 className="title-font text-2xl font-bold text-gray-900 mb-3" >The DetoxYourMind</h1>
                    <p className="leading-relaxed mb-3">Unlocking Clarity: A Journey to Detox Your Mind and Renew Your Perspective.</p>
                  </div>
                </div>
              </div>
            </div>
